...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lister les séances (public), filtrable par film' }),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: "Détails d'une séance (public)" }),
...
__decorate([
    ...
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Créer une séance' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(role_enum_1.Role.ADMIN),
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Modifier une séance' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '[Admin] Supprimer une séance' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.SessionsController = SessionsController = __decorate([
    (0, swagger_1.ApiTags)('Sessions (Séances)'),
